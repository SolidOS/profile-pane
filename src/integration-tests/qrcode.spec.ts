...
describe("profile-pane", () => {
  ...
  describe("qrcode", () => {
    ...
    it("renders the QRCode canvas", () => {
      ...
      expect(element.innerHTML).toContain('<canvas class="QRCode" }="" style="width: 80%; margin:auto;" data-value="https://janedoe.example/profile/card#me" highlightcolor="#06b74a" backgroundcolor="#f4f5c2"></canvas>')
