...
const starIconSvg = '<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none" aria-hidden="true" focusable="false"><rect width="30" height="30" rx="5" fill="black" fill-opacity="0.2"/><path d="M14.1093 6.74536C14.4804 6.01811 15.5196 6.01811 15.8907 6.74536L17.7665 10.4209C17.9118 10.7056 18.1844 10.9037 18.5001 10.9539L22.5754 11.6021C23.3817 11.7303 23.7028 12.7186 23.1259 13.2963L20.2099 16.216C19.984 16.4422 19.8798 16.7627 19.9296 17.0785L20.5726 21.1546C20.6998 21.9611 19.8591 22.5719 19.1314 22.2017L15.4534 20.3307C15.1685 20.1857 14.8315 20.1857 14.5466 20.3307L10.8686 22.2017C10.1409 22.5719 9.30023 21.9611 9.42744 21.1546L10.0704 17.0785C10.1202 16.7627 10.016 16.4422 9.79012 16.216L6.87413 13.2963C6.29716 12.7186 6.61827 11.7303 7.42462 11.6021L11.4999 10.9539C11.8156 10.9037 12.0882 10.7056 12.2335 10.4209L14.1093 6.74536Z" fill="#F4F4F4"/></svg>'

export const starIconAsset = `data:image/svg+xml;utf8,${encodeURIComponent(starIconSvg)}`
...
export const searchIcon = html`
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    focusable="false"
  >
    <path d="M6.16457 0C2.76552 0 0 2.76589 0 6.16539C0 9.56509 2.76552 12.3308 6.16457 12.3308C9.56382 12.3308 12.3291 9.56509 12.3291 6.16539C12.3291 2.76589 9.56382 0 6.16457 0ZM6.16457 11.1926C3.39298 11.1926 1.13808 8.93738 1.13808 6.16542C1.13808 3.39346 3.39298 1.13823 6.16457 1.13823C8.93616 1.13823 11.1911 3.39344 11.1911 6.16539C11.1911 8.93735 8.93616 11.1926 6.16457 11.1926Z" fill="#99A1AF"/>
  </svg>
`
