...
describe('Dialog accessibility', () => {
  ...
  /* Prompt: adjust keyboard interaction coverage so shared dialogs do not programmatically change focus on open or cancel */
  it('does not programmatically move focus on open or cancel', async () => {
